...
class Layer8Designer(LayerDesigner):
    ...
    def design(self, lower_spec: DesignSpec = None, **kwargs):
        ...
        c_score_data = {
            "gate1_phi_c": True,  # Self-modeling via ⊙
            "gate2_k_slow": True, # Slow kinetics via 𐑧
            "eternal_chirality": True,  # via 𐑫
            "non_abelian": True,   # via 𐑟
            "self_written_state": True,  # via 𐑦
            "frobenius_special": True,  # via 𐑹
            "score": 1.0,  # Gate 1 + Gate 2 both open, O_inf
        }
        ...
        design_data = {
            ...
            "tier": "O_inf",
            "notes": f"Whole {organism_type} organism — O_inf, C=1.0",
        }
