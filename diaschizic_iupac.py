...
DIASCHIZICS: Dict[str, Dict] = {
    ...
    "diabaton": {
        ...
        "tuple": {"D": "𐑦", "T": "𐑸", "R": "𐑾", "P": "𐑹", "F": "𐑐",
                  ...
                  "S": "𐑳", "W": "𐑭"},
        "tier": "O_2†",
        "pharmacophore_hint": "Tryptamine with self-referential topology — macrocyclic tryptamine dimer with integer-winding topology, the threshold between O_2 and O_inf",
        "predicted_scaffold": "Macrocyclic bis-tryptamine — cyclophane with integer winding and self-referential topology",
        "innovations": ["O_2† tier", "T=𐑸 + H=𐑖 + Ω=𐑭 threshold"],
    },
}
