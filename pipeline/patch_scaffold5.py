...
if __name__ != "__main__":
    raise ImportError(
        "patch_scaffold5.py rewrites another module; run it directly, do not import it")
...
# Find the continuation line (fg2 child_b)
for i, line in enumerate(lines):
    if "fg_hint=cut['fg2']" in line and ')' in line:
