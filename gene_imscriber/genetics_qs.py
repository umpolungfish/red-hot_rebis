...
info_line("  iff p2=T OR (p2=N AND p1 in {T,B}) OR (p2=B AND p1 in {T,B}).")
print()
info_line("  Counting:")
info_line("    p2=T (C): 4 exact (any p1)")
info_line("    p2=N (U), p1 in {T,B}: CU_, GU_ = 2 exact")
info_line("    p2=B (G), p1 in {T,B}: CG_, GG_ = 2 exact")
info_line("    Total: 4+2+2 = 8 EXACT (out of 16)")
print()
info_line("  Why this rule? In B4 terms, the third-position pyrimidine/purine")
info_line("  distinction {N,T} vs {F,B} is relevant only when")
info_line("  the prefix has p2 in N/F (weak) or p2=B with p1 weak.")
info_line("  When p2=T the codon is locked regardless of p3.")
info_line("  When p2=N but p1 in {T,B}, the first base compensates.")
print()
...
info_line("  is absorbed exactly when the prefix lies in a 'counital'")
...
info_line("    - The Omega structure forces 3 stops, consuming UA_'s purine half.")
print()
...
info_line("="*70)
print()
info_line("The genetic code's 20 AAs arise from the IG Crystal of Types as:")
print()
