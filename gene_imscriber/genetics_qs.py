...
print("  O₀ -> O₁: phi_z -> phi_c   (criticality: self-modeling gate opens)")
print("  O₁ -> O₂: D_point->D_tri, O₀->O_Z2 (dimensionality + winding)")
print("  O₂ -> O₂†: D_tri->D_infty   (further dimensional expansion)")
print("  O₂† -> O_∞: P_asym->P_pmsym (Frobenius: mu o delta = id)")
print()
print("The 8 ground-layer AAs = O₀ tier fixed points:")
...
print("  8+12=20 = minimal Frobenius-closed O_∞-compatible AA set.")
print()
...
print()
print("  8 (ground layer, O₀) + 12 (promoted, O₁-O_∞) = 20")
print()
...
print("  - O_∞ closure: 12 promotions for 12 primitives")
print()
